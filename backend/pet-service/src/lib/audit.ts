...
/**
 * Chaves cujo valor nunca vai para `before`/`after` em claro. Além da PII do tutor,
 * o microchip: identificador único rastreável do animal (PRD pets_03 §4).
 */
 ...
 *
 * O PRD §9 pede `pet.updated` com o diff: o que interessa na trilha é *que* o
 * microchip mudou e quem mudou, nunca o número em si — para lê-lo há o endpoint
