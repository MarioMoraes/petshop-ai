...
import { EVENTS_DLX, EVENTS_EXCHANGE, type PetEventMap } from '@petshop/shared-types'
import { loadEnv } from '../env.js'
import { logger } from './logger.js'

/**
 * Publicação de eventos de domínio (PRD pets_03 §8).
 *
 ...
 * Perder um evento é aceitável; perder o cadastro do pet não é.
 *
...
export async function publishEvent<K extends keyof PetEventMap>(
  routingKey: K,
  payload: Omit<PetEventMap[K], 'timestamp'>,
): Promise<void> {
