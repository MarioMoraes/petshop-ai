...
describe('MOD-SEC-07 — os emissores que faltavam', () => {
  ...
  it('AC-02: assinatura de serviço inválida vira WEBHOOK_SIGNATURE_INVALID', async () => {
    ...
    const response = await app.inject({
      method: 'GET',
      url: '/v1/professionals',
      headers: signServiceHeaders({ clerkUserId: 'user_forjado', permissions: [] }, 'outro-segredo'),
    })
