...
/**
 * Geração de PDF (MOD-DOC-07 e 08), sobre o Gotenberg.
 *
 ...
 *
 * Mesma forma do `lib/pdf.ts` do financeiro e do prontuário. As três cabem em cinco
 * linhas porque o que é comum já foi extraído.
 */
