...
import { futureAppointmentsBlock, invalid, notFound } from '../scheduling/errors.js'
...
export async function createProfessional(actor: ActorContext, input: CreateProfessionalInput) {
  ...
  await invalidateScheduleCatalog(actor.tenantId, [created.id])
...
export async function updateProfessional(
  ...
  await invalidateScheduleCatalog(actor.tenantId, [professionalId])
  await publishEvent('agenda.profissional.alterado', {
    tenantId: actor.tenantId,
    professionalId,
