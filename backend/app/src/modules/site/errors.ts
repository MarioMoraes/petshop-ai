 ...
 *
 * A tradução para `application/problem+json` é do host (`shared/errors.ts`), que
 * registra um error handler só para o processo; o que fica aqui é o catálogo — quais
 * códigos existem e que regra produz cada um.
 *
