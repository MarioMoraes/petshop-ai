 ...
 *
 * No formulário público não há usuário, e `actorUserId` é nulo: quem escreveu foi um
 * visitante. O `ipAddress` continua importando, e é o único traço que sobra dele.
 */
