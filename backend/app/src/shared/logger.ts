...
export const { loggerOptions, logger, recordMetric, drainMetrics } = createLogger({
  ...
  redact: [
    ...
    '*.suspensionReason',
    /**
     * MOD-PORTAL — o identificador que o tutor digita na porta é o dado mais sensível que
     * este processo toca. Ele é o par "esta pessoa é cliente deste petshop", e um log com
     * ele desfaz, num arquivo de texto, a resposta uniforme que o módulo inteiro constrói.
     */
    '*.identifier',
    '*.code',
    '*.maskedTarget',
