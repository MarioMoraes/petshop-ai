...
/**
 * Eventos de segurança (MOD-SEC). O medical-record-service registra as negações de permissão
 * do PRD prontuario_04 §9 e as tentativas de alcançar prontuário de outro tenant.
 *
