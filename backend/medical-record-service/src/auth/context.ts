 ...
 *
 * Idêntico ao do identity-service e do tutor-service por construção — o contrato HMAC gateway→serviço é
...
/**
 * `preHandler` que exige uma permissão da matriz (PRD prontuario_04 §9).
 *
 * A negação vira 403 `ERR_PET_003` e é registrada em `audit_logs` com
