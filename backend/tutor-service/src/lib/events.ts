...
import { EVENTS_DLX, EVENTS_EXCHANGE, type TutorEventMap } from '@petshop/shared-types'
import { loadEnv } from '../env.js'
import { logger } from './logger.js'

/**
 * Publicação de eventos de domínio (PRD tutores_02 §8).
 *
 ...
 * Perder um evento é aceitável; perder o cadastro do tutor não é.
 *
...
export async function publishEvent<K extends keyof TutorEventMap>(
  routingKey: K,
  payload: Omit<TutorEventMap[K], 'timestamp'>,
): Promise<void> {
