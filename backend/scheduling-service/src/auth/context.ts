...
/**
 * Autenticação de serviço da agenda: o contrato HMAC gateway→serviço vem do
 * `@petshop/service-kit`; o que se liga aqui é o catálogo de erro e a trilha de
 * auditoria deste serviço. A negação de permissão vira 403 `ERR_AGENDA_003`
 * (PRD agenda_operacao_06 §9).
 */
