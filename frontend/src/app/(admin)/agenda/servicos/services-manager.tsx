    ...
    <div className="space-y-4">
      ...
      {services.map((service) => (
        <ServiceRow
          ...
          onToggleSite={() =>
            run(() => updateServiceAction(service.id, { showOnSite: !service.showOnSite }))
          }
    ...
    <Card>
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          {/*
            AC-04 de MOD-SITE-05: a vitrine é subconjunto do catálogo, não espelho
            dele. Desmarcado, o serviço sai da página pública e **continua agendável
            no balcão** — que é o que distingue isto de "Desativar", o qual o tira dos
            dois lugares. Fica junto do nome, e não numa tela de configuração do site,
            porque a decisão é sobre este serviço.
          */}
          {service.active && (
