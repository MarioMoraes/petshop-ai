...
/**
 * A caixa de mercadoria — o estoque. Tom: `icon-money`.
 *
 * O tom é o do dinheiro porque o que o estoque guarda é custo parado na prateleira, e
 * ele mora no menu junto do Financeiro e da Cobrança.
 */
/**
 * A cédula do caixa do dia (MOD-CAIXA). Tom do dinheiro, como a carteira do Financeiro:
 * as duas moram juntas no menu, e o desenho é o que diz qual é a gaveta.
 */
